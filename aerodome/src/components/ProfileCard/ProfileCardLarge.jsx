...
<div className="bg-[##FFFFFF0A] abolute border-2  border-[#FFFFFF1A] text-white p-4 rounded-[29px] w-[17rem] h-[42vh] flex flex-col justify-center items-center space-y-2  transition duration-300 ease-in-out">
